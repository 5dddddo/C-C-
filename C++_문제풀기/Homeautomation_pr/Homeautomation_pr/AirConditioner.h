...
{
public:
	AirConditioner() :Appliance(), machineState(SENDAIR),setTemperature(25){} // Appliance는 default 생성자로 생성, machineState는 송풍으로 초기화
	AirConditioner(string machineName, int powerConsumption)
		:Appliance(machineName, powerConsumption, false, 0, 0), machineState(SENDAIR), setTemperature(25){}// Appliance는 Overloaded 생성자로 생성, machineState는 송풍으로 초기화
