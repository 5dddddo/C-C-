...
typedef CSearchHistory ListElementType;
class List {
...
public:
	...
	bool find(ListElementType& elem, string newWord);
	bool deleteNode(string deleteWord);
	void AddSearch(ListElementType& elem);
	void AddAll(List & addList);
private:
